...
\begin{figure*}[t]
  ...
  \subfigure[\small One Process failing at a time]{
    \label{fig:onebyone}
    \includegraphics[scale=0.65]{even.pdf}
  }
  \subfigure[\small Two concurrently failing processes]{
    \label{fig:burst}
    \includegraphics[scale=0.65]{burst.pdf}
  }
...
\begin{figure*}[t]
  ...
  \subfigure[\small Detection Time for Failures]{
    \label{fig:detection}
    \includegraphics[scale=0.65]{epochs-lines.pdf}
  }
  \subfigure[\small Overhead Introduced by Changes]{
    \label{fig:overhead}
    \includegraphics[scale=0.65]{overhead.pdf}
  }
